(function(window, document){
  ...
  var ballX = 150, // Ball x position.
      ...
      buttonCanvas = buttonSection.children[0],
      buttonSvg = buttonSection.children[1];
  ...
  // use addEventListener binding click function
  buttonCanvas[window.addEventListener ? 'addEventListener' : 'attachEvent']( window.addEventListener ? 'click' : 'onclick', function(){
    console.log('in');
    drawGame('cvs');
  }, false);
  buttonSvg[window.addEventListener ? 'addEventListener' : 'attachEvent']( window.addEventListener ? 'click' : 'onclick', function(){
    drawGame('svg');
  }, false);
